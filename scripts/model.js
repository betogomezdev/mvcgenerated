/**
 * backbone model definitions for CODEIGTESTUNO
 */
...
/**
 * Tbldistritos Backbone Model
 */
model.TbldistritosModel = Backbone.Model.extend({
	urlRoot: 'api/tbldistritos',
	idAttribute: 'id',
	id: '',
	nombre: '',
	defaults: {
...
/**
 * Tbldistritos Backbone Collection
 */
model.TbldistritosCollection = model.AbstractCollection.extend({
	url: 'api/tbldistritoses',
	model: model.TbldistritosModel
});

/**
 * Tbleventos Backbone Model
 */
model.TbleventosModel = Backbone.Model.extend({
	urlRoot: 'api/tbleventos',
	idAttribute: 'id',
	id: '',
	nombre: '',
	defaults: {
...
/**
 * Tbleventos Backbone Collection
 */
model.TbleventosCollection = model.AbstractCollection.extend({
	url: 'api/tbleventoses',
	model: model.TbleventosModel
});
