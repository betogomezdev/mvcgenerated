...
<html lang="en">
	<head>
		...
		<meta name="description" content="CODEIGTESTUNO" />
			...
			<div class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-inner">
					<div class="container">
						...
						<a class="brand" href="./">CODEIGTESTUNO</a>
						<div class="nav-collapse collapse">
							<ul class="nav">
								<li <?php if ($this->nav=='tbldistritoses') { echo 'class="active"'; } ?>><a href="./tbldistritoses">Tbldistritoses</a></li>
								<li <?php if ($this->nav=='tbleventoses') { echo 'class="active"'; } ?>><a href="./tbleventoses">Tbleventoses</a></li>
								</ul>
								</li>
							</ul>
