...
GlobalConfig::$CONNECTION_SETTING->DBName = "codeigtestuno";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "newpassword";
...
/** the root url of the application with trailing slash, for example http://localhost/codeigtestuno/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'codeigtestuno/';
