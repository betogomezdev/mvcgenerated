...
require_once("DAO/TbleventosCriteriaDAO.php");

/**
 * The TbleventosCriteria class extends TbleventosDAOCriteria and is used
 ...
 * @version 1.0
 */
class TbleventosCriteria extends TbleventosCriteriaDAO
{
