...
require_once("DAO/TbldistritosCriteriaDAO.php");

/**
 * The TbldistritosCriteria class extends TbldistritosDAOCriteria and is used
 ...
 * @version 1.0
 */
class TbldistritosCriteria extends TbldistritosCriteriaDAO
{
